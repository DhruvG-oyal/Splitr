import {
  Coffee, ShoppingBag, Utensils, Plane, Car, Home, Film, ShoppingCart,
  Ticket, Wifi, Droplets, GraduationCap, Heart, Stethoscope, Gift,
  Smartphone, MoreHorizontal, CreditCard, Baby, Music, Book, DollarSign,
} from "lucide-react";
...
export const EXPENSE_CATEGORIES = {
  ...
  housing: { id: "housing", name: "Housing", icon: Home },
  ...
  technology: { id: "technology", name: "Technology", icon: Smartphone },
...
export const getCategoryById = (id) => EXPENSE_CATEGORIES[id] || EXPENSE_CATEGORIES.other;
